...
"------------------=== Other ===----------------------
Plugin 'vim-airline/vim-airline'        " lean & mean status/tabline for vim that's light vas air
Plugin 'vim-airline/vim-airline-themes' " lean & mean status/tabline for vim that's light vas air
Plugin 'fisadev/FixedTaskList.vim'      " Pending tasks list
Plugin 'rosenfeld/conque-term'          " Consoles as buffers
Plugin 'tpope/vim-surround'             " Parentheses, brackets, quotes, XML tags, and more
Plugin 'Townk/vim-autoclose'            " Autoclose parentheses, brackets, quotes
Plugin 'w0ng/vim-hybrid'                " A dark colour scheme for Vim 
Plugin 'tomtom/tcomment_vim'            " Comments for Vim
...
" --- GitGutter ---
Plugin 'airblade/vim-gitgutter'         " Gitgutter shows whether each line has been modified 
